...
type Props = { dados: Confirmacao; onDados: (dados: Confirmacao) => void; pedido: ItemPedido[]; gancho: Gancho | null; onSair: () => void; onQuantidade: (id: string, d: number) => void; onRemover: (id: string) => void; onModificar: (id: string, bacon?: boolean) => void; onGancho: () => void; onDispensar: () => void }
    ...
    <div data-carrinho className="carrinho-folha">
      ...
      {!!pedido.length && <div className="carrinho-base">
        ...
        {resumo ? <div className="resumo-acoes">
          ...
          <button className="botao-texto" onClick={() => setResumo(false)}>Voltar aos itens</button>
